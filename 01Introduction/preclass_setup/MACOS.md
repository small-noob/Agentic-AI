...
1. Download the macOS version that matches your Mac from the [VS Code download page](https://code.visualstudio.com/download), then install it.
...
You only need this step if you do not want to use VS Code. Open Terminal and run:
