...
ATTACKS: list[Attack] = [
    ...
    Attack("symlink_to_file", "escape_secrets", "follow a symlink to an outside file"),
    Attack("symlink_to_dir", "escape_dir/secrets.env", "follow a symlink to an outside folder"),
    Attack("symlink_absolute", "escape_etc", "follow a symlink to an absolute path"),
